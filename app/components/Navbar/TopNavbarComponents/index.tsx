...
const TopNavbarComponents = () => {
  ...
  return (
    <section className="w-11/12 mx-auto flex justify-between items-center h-16 tablet:w-10/12 tablet:h-24 tablet:border-b-[1px] tablet:border-neutral-grayishBlue">
